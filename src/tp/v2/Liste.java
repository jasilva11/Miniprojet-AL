...
/*
 * - Liste d√©finie inductivement
 * l ::= Vide (cf. casVide)
 *     | Cons(e, l) (cf. casCons, tete, reste)
 * - accesseurs suppl√©mentaires : taille, estVide
 * - services : iterator, miroir    
 */
/**
 * Interface qui sert ‡† modÈliser une liste immutable.
...
public interface Liste<E> extends Iterable<E> {
	 ...
	 * @throws UnsupportedOperationException au cas ou une operation qui n'est pas support√©e est executee
	 */
	...
	* @throws UnsupportedOperationException au cas ou une operation qui n'est pas supportÈe est executÈe
	*/
