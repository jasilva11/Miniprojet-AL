...
public class Test {
	...
	* @throws UnsupportedOperationException au cas ou une operation qui n'est pas supportée est executee
	*/
	private static<T extends ListeImmutable<Integer>> void testListePasVide(ListeImmutable<Integer> liste) {
		System.out.println("******");
		...
		System.out.println("Miroir du liste");
		ListeImmutable<Integer> miroir = liste.miroir();
		System.out.println("La liste : "+liste.toStringListe());
	...
	* @throws UnsupportedOperationException au cas ou une operation qui n'est pas supportée est executee
	*/
	private static<T extends ListeImmutable<Integer>> void testListeVide(ListeImmutable<Integer> liste) {
		System.out.println("******");
	...
	*/
	public static void main(String[] args) {
		...
		ListeImmutable<Integer> listeVide = ListeImmutable.vide();
		ListeImmutable<Integer> liste = ListeImmutable.cons(1, ListeImmutable.cons(2, ListeImmutable.cons(3, listeVide)));
